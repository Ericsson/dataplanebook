...
This chapter describes the DPDK threading model. The DPDK way of using
threads is a prototypical model for data plane threading, justifying
the section's more abstract title.
